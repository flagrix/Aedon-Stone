...
public class PortalMulti : MonoBehaviour
{
    ...
    public void TogglePortal(bool _activate)
    {
        ...
        {
            GetComponent<PhotonView>().RPC("RPC_TogglePortal", RpcTarget.AllBuffered, _activate);
        }
    }

    [PunRPC]
    private void RPC_TogglePortal(bool _activate)
    {
